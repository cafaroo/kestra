...
public class McpServerAuthenticationFilter implements HttpServerFilter {
    ...
    /**
     * Resolves the {@code id} path variable of a matched {@link McpToolController} route — the same
     * URL-decoded value the controller's {@code @PathVariable} binds — instead of splitting
